...
#ifndef __PACKET_SERVICES_H__
#define __PACKET_SERVICES_H__
...
gboolean    _ps_master_get_storage_value(gpointer master, TcoreStorageKey key);
gboolean    _ps_master_set_storage_value(gpointer master, TcoreStorageKey key, gboolean value);
...
gboolean    _ps_service_set_access_technology(gpointer service, TelNetworkAct value);
